		...
		<div class="container-fluid">
			<c:forEach var="m" items="${todayOrder }">
				<div class="row">
					...
					<div class='col-lg-2'>订单总金额:${m.value.orderPrice }</div>
					<div class='col-lg-2'>买家:${m.value.seller.name }</div>
				...
				<div class="row"><a href="${pageContext.request.contextPath }/good/detail?id=${g.key.goodId}">
					...
					<div class='col-lg-6'>${fn:substring(g.key.goodDesc,0,fn:length(g.key.goodDesc)/2)}...</div>
